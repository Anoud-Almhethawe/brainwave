...
const Header = () => {
  ...
  return (
    ...
    >
      <div className="flex items-center px-5 l:px-7.5 xl:px-10 max-lg:py-4 ">
        <a className="block w-[192px] xl:mr-8 " href="#hero">
        ...
        <nav
          ...
          } fixed top-[80px] left-0 right-0 bottom-0 bg-n-8 lg:static 
          ...
          >
            {navigation.map((item) => (
              <a
                ...
                uppercase text-2xl hover:text-color-1 
                ${
                  item.onlyMobile ? "lg:hidden first-line:" : ""
